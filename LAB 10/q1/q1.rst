                                      ...
                                      4 ; This file was generated Wed Oct 25 09:57:27 2023
                                      5 ;--------------------------------------------------------
                                      6 	.module q1
      ...
      000010                        671 _voltage::
      000010                        672 	.ds 4
                           00000C   673 Lq1.LCD_StringWrite$length$1$36==.
      ...
      00004B 02 02 47         [24]  755 	ljmp	_it_SPI
                           ...
                           000000   769 	C$q1.c$26$1$42 ==.
                                    770 ;	q1.c:26: int adcVal=0, avgVal=0; //initVal=0;
      0000AA E4               [12]  771 	clr	a
      0000AB F5 08            [12]  772 	mov	_adcVal,a
      0000AD F5 09            [12]  773 	mov	(_adcVal + 1),a
                           000005   774 	C$q1.c$26$1$42 ==.
                                    775 ;	q1.c:26: unsigned char serial_data;
      0000AF F5 0A            [12]  776 	mov	_avgVal,a
      0000B1 F5 0B            [12]  777 	mov	(_avgVal + 1),a
                           000009   778 	C$q1.c$30$1$42 ==.
                                    779 ;	q1.c:30: unsigned char i=0;
                                    780 ;	1-genFromRTrack replaced	mov	_i,#0x00
      0000B3 F5 0F            [12]  781 	mov	_i,a
                           00000B   782 	C$q1.c$23$1$42 ==.
                                    783 ;	q1.c:23: __bit transmit_completed= 0;					// To check if spi data transmit is complete
      0000B5 C2 00            [12]  784 	clr	_transmit_completed
                           00000D   785 	C$q1.c$24$1$42 ==.
                                    786 ;	q1.c:24: __bit take_samples=0;
      ...
      00004E 02 00 BC         [24]  796 	ljmp	_main
                           ...
                           000000   806 	C$q1.c$40$0$0 ==.
                                    807 ;	q1.c:40: void main(void)
                                    808 ;	-----------------------------------------
                                    809 ;	 function main
                                    810 ;	-----------------------------------------
      0000BC                        811 _main:
                           ...
                           000001   818 	ar1 = 0x01
                           000000   819 	ar0 = 0x00
                           000000   820 	C$q1.c$42$1$20 ==.
                                    821 ;	q1.c:42: P2 = 0x00;								// Make Port 2 output .. for LCD data
      0000BC 75 A0 00         [24]  822 	mov	_P2,#0x00
                           000003   823 	C$q1.c$43$1$20 ==.
                                    824 ;	q1.c:43: P1 &= 0xEF;								// Make P1 Pin4 as output
      0000BF 53 90 EF         [24]  825 	anl	_P1,#0xEF
                           000006   826 	C$q1.c$44$1$20 ==.
                                    827 ;	q1.c:44: P0 &= 0xF8;								// Make Port 0 Pins 0,1,2 output
      0000C2 53 80 F8         [24]  828 	anl	_P0,#0xF8
                           000009   829 	C$q1.c$46$1$20 ==.
                                    830 ;	q1.c:46: SPI_Init();
      0000C5 12 02 70         [24]  831 	lcall	_SPI_Init
                           00000C   832 	C$q1.c$47$1$20 ==.
                                    833 ;	q1.c:47: LCD_Init();
      0000C8 12 02 A1         [24]  834 	lcall	_LCD_Init
                           00000F   835 	C$q1.c$48$1$20 ==.
                                    836 ;	q1.c:48: Timer_Init();
      0000CB 12 02 8E         [24]  837 	lcall	_Timer_Init
                           000012   838 	C$q1.c$49$1$20 ==.
                                    839 ;	q1.c:49: LCD_StringWrite("Voltage: xxxxmv", 15);
      ...
      0000D7 12 02 F8         [24]  843 	lcall	_LCD_StringWrite
                           00001E   844 	C$q1.c$53$2$21 ==.
                                    845 ;	q1.c:53: while(take_samples)                     //Take 10 samples at regular intervals using timer and 
      0000DA                        846 00111$:
      0000DA 30 01 FD         [24]  847 	jnb	_take_samples,00111$
                           000021   848 	C$q1.c$57$3$22 ==.
                                    849 ;	q1.c:57: for(i = 0; i < 10; i++)
      0000DD 75 0F 00         [24]  850 	mov	_i,#0x00
      0000E0 C2 01            [12]  851 	clr	_take_samples
      0000E2                        852 00117$:
                           000026   853 	C$q1.c$59$4$23 ==.
                                    854 ;	q1.c:59: CS_BAR = 0;                 // enable ADC as slave		 
      0000E2 C2 94            [12]  855 	clr	_P1_4
                           000028   856 	C$q1.c$60$4$23 ==.
                                    857 ;	q1.c:60: SPDAT= 0x01;		    // Write start bit to start ADC(Timing Diagram) 
      0000E4 75 C5 01         [24]  858 	mov	_SPDAT,#0x01
                           00002B   859 	C$q1.c$61$4$23 ==.
                                    860 ;	q1.c:61: while(!transmit_completed);	// wait end of transmition;
      0000E7                        861 00101$:
                           00002B   862 	C$q1.c$62$4$23 ==.
                                    863 ;	q1.c:62: transmit_completed = 0;    	// clear software transfert flag 
      0000E7 10 00 02         [24]  864 	jbc	_transmit_completed,00152$
      0000EA 80 FB            [24]  865 	sjmp	00101$
      0000EC                        866 00152$:
                           000030   867 	C$q1.c$63$4$23 ==.
                                    868 ;	q1.c:63: SPDAT= 0x80;			// 80H written to start ADC CH0 single ended sampling(refer D0D1D2config diag.)
      0000EC 75 C5 80         [24]  869 	mov	_SPDAT,#0x80
                           000033   870 	C$q1.c$64$4$23 ==.
                                    871 ;	q1.c:64: while(!transmit_completed);	// wait end of transmition 
      0000EF                        872 00104$:
      0000EF 30 00 FD         [24]  873 	jnb	_transmit_completed,00104$
                           000036   874 	C$q1.c$65$4$23 ==.
                                    875 ;	q1.c:65: data_save_high = serial_data & 0x03 ;  //
      0000F2 74 03            [12]  876 	mov	a,#0x03
      0000F4 55 0C            [12]  877 	anl	a,_serial_data
      0000F6 F5 0D            [12]  878 	mov	_data_save_high,a
                           00003C   879 	C$q1.c$66$4$23 ==.
                                    880 ;	q1.c:66: transmit_completed = 0;    	// clear software transfer flag 
      0000F8 C2 00            [12]  881 	clr	_transmit_completed
                           00003E   882 	C$q1.c$68$4$23 ==.
                                    883 ;	q1.c:68: SPDAT= 0x00;			// 
      0000FA 75 C5 00         [24]  884 	mov	_SPDAT,#0x00
                           000041   885 	C$q1.c$69$4$23 ==.
                                    886 ;	q1.c:69: while(!transmit_completed);	// wait end of transmition 
      0000FD                        887 00107$:
      0000FD 30 00 FD         [24]  888 	jnb	_transmit_completed,00107$
                           000044   889 	C$q1.c$70$4$23 ==.
                                    890 ;	q1.c:70: data_save_low = serial_data;
      000100 85 0C 0E         [24]  891 	mov	_data_save_low,_serial_data
                           000047   892 	C$q1.c$71$4$23 ==.
                                    893 ;	q1.c:71: transmit_completed = 0;    	// clear software transfer flag 
      000103 C2 00            [12]  894 	clr	_transmit_completed
                           000049   895 	C$q1.c$72$4$23 ==.
                                    896 ;	q1.c:72: CS_BAR = 1;                	// disable ADC as slave
      000105 D2 94            [12]  897 	setb	_P1_4
                           00004B   898 	C$q1.c$74$4$23 ==.
                                    899 ;	q1.c:74: adcVal = (data_save_high <<8) + (data_save_low);
      ...
      000115 F5 09            [12]  909 	mov	(_adcVal + 1),a
                           00005B   910 	C$q1.c$75$4$23 ==.
                                    911 ;	q1.c:75: avgVal += adcVal;		// accumulate the readings in avgVal
      ...
      000121 F5 0B            [12]  917 	mov	(_avgVal + 1),a
                           000067   918 	C$q1.c$57$3$22 ==.
                                    919 ;	q1.c:57: for(i = 0; i < 10; i++)
      000123 05 0F            [12]  920 	inc	_i
      000125 74 F6            [12]  921 	mov	a,#0x100 - 0x0A
      000127 25 0F            [12]  922 	add	a,_i
      000129 50 B7            [24]  923 	jnc	00117$
                           00006F   924 	C$q1.c$78$1$20 ==.
                                    925 ;	q1.c:78: avgVal = avgVal/10.0;			// the average reading
      ...
      000166 12 04 ED         [24]  956 	lcall	___fs2sint
                           0000AD   957 	C$q1.c$79$1$20 ==.
                                    958 ;	q1.c:79: avgVal = avgVal*(3300.0/1024.0); // in mV
      ...
      0001A9 85 83 0B         [24]  988 	mov	(_avgVal + 1),dph
                           0000F0   989 	C$q1.c$80$3$22 ==.
                                    990 ;	q1.c:80: LCD_CmdWrite(0x89);		 //
      0001AC 75 82 89         [24]  991 	mov	dpl,#0x89
      0001AF 12 02 C0         [24]  992 	lcall	_LCD_CmdWrite
                           0000F6   993 	C$q1.c$81$3$22 ==.
                                    994 ;	q1.c:81: voltage[3] = avgVal%10 + 0x30; // add 0x30 to convert the corresponding number to ASCII
      ...
      0001C6 F5 13            [12] 1003 	mov	(_voltage + 0x0003),a
                           00010C  1004 	C$q1.c$82$1$20 ==.
                                   1005 ;	q1.c:82: avgVal = avgVal/10;
      ...
      0001D4 12 06 B2         [24] 1010 	lcall	__divsint
                           00011B  1011 	C$q1.c$83$3$22 ==.
                                   1012 ;	q1.c:83: voltage[2] = avgVal%10 + 0x30;
      ...
      0001EB F5 12            [12] 1021 	mov	(_voltage + 0x0002),a
                           000131  1022 	C$q1.c$84$1$20 ==.
                                   1023 ;	q1.c:84: avgVal = avgVal/10;
      ...
      0001F9 12 06 B2         [24] 1028 	lcall	__divsint
                           000140  1029 	C$q1.c$85$3$22 ==.
                                   1030 ;	q1.c:85: voltage[1] = avgVal%10 + 0x30;
      ...
      000210 F5 11            [12] 1039 	mov	(_voltage + 0x0001),a
                           000156  1040 	C$q1.c$86$1$20 ==.
                                   1041 ;	q1.c:86: avgVal = avgVal/10;
      ...
      00021E 12 06 B2         [24] 1046 	lcall	__divsint
                           000165  1047 	C$q1.c$87$1$20 ==.
                                   1048 ;	q1.c:87: voltage[0] = avgVal%10 + 0x30;
      ...
      000235 F5 10            [12] 1057 	mov	_voltage,a
                           00017B  1058 	C$q1.c$88$3$22 ==.
                                   1059 ;	q1.c:88: LCD_StringWrite(voltage, 4);
      ...
      000246 22               [24] 1067 	ret
                           ...
                           00018B  1072 	C$q1.c$99$1$20 ==.
                                   1073 ;	q1.c:99: void it_SPI(void) __interrupt 9 /* interrupt address is 0x004B */
                                   1074 ;	-----------------------------------------
      ...
      00024B 75 D0 00         [24] 1080 	mov	psw,#0x00
                           000192  1081 	C$q1.c$101$1$25 ==.
                                   1082 ;	q1.c:101: switch	( SPSTA )         /* read and clear spi status register */
      ...
      00025A BF 80 05         [24] 1090 	cjne	r7,#0x80,00105$
                           0001A1  1091 	C$q1.c$104$2$26 ==.
                                   1092 ;	q1.c:104: serial_data=SPDAT;   /* read receive data */
      00025D 85 C5 0C         [24] 1093 	mov	_serial_data,_SPDAT
                           0001A4  1094 	C$q1.c$105$2$26 ==.
                                   1095 ;	q1.c:105: transmit_completed=1;/* set software flag */
      000260 D2 00            [12] 1096 	setb	_transmit_completed
                           0001A6  1097 	C$q1.c$115$1$25 ==.
                                   1098 ;	q1.c:115: }
      000262                       1099 00105$:
      000262 D0 D0            [24] 1100 	pop	psw
      000264 D0 07            [24] 1101 	pop	ar7
                           0001AA  1102 	C$q1.c$116$1$25 ==.
      ...
      000266 32               [24] 1104 	reti
                           ...
                           0001AB  1113 	C$q1.c$118$1$25 ==.
                                   1114 ;	q1.c:118: void timer0_ISR (void) __interrupt 1
                                   1115 ;	-----------------------------------------
                                   1116 ;	 function timer0_ISR
                                   1117 ;	-----------------------------------------
      000267                       1118 _timer0_ISR:
                           0001AB  1119 	C$q1.c$120$1$28 ==.
                                   1120 ;	q1.c:120: TH0 = 0x3C;	//For 25ms operation
      000267 75 8C 3C         [24] 1121 	mov	_TH0,#0x3C
                           0001AE  1122 	C$q1.c$121$1$28 ==.
                                   1123 ;	q1.c:121: TL0 = 0xB0;
      00026A 75 8A B0         [24] 1124 	mov	_TL0,#0xB0
                           0001B1  1125 	C$q1.c$122$1$28 ==.
                                   1126 ;	q1.c:122: take_samples = 1;
      00026D D2 01            [12] 1127 	setb	_take_samples
                           0001B3  1128 	C$q1.c$123$1$28 ==.
      ...
      00026F 32               [24] 1130 	reti
                           ...
                           0001B4  1141 	C$q1.c$132$1$28 ==.
                                   1142 ;	q1.c:132: void SPI_Init()
                                   1143 ;	-----------------------------------------
                                   1144 ;	 function SPI_Init
                                   1145 ;	-----------------------------------------
      000270                       1146 _SPI_Init:
                           0001B4  1147 	C$q1.c$134$1$29 ==.
                                   1148 ;	q1.c:134: CS_BAR = 1;	                 // DISABLE ADC SLAVE SELECT-CS 
      000270 D2 94            [12] 1149 	setb	_P1_4
                           0001B6  1150 	C$q1.c$135$1$29 ==.
                                   1151 ;	q1.c:135: SPCON |= 0x20;               	 // P1.1(SSBAR) is available as standard I/O pin
      000272 43 C3 20         [24] 1152 	orl	_SPCON,#0x20
                           0001B9  1153 	C$q1.c$136$1$29 ==.
                                   1154 ;	q1.c:136: SPCON |= 0x01;                	// Fclk Periph/4 AND Fclk Periph=12MHz ,HENCE SCK IE. BAUD RATE=3000KHz 
      000275 43 C3 01         [24] 1155 	orl	_SPCON,#0x01
                           0001BC  1156 	C$q1.c$137$1$29 ==.
                                   1157 ;	q1.c:137: SPCON |= 0x10;               	 // Master mode ..configure SPI as master
      000278 43 C3 10         [24] 1158 	orl	_SPCON,#0x10
                           0001BF  1159 	C$q1.c$138$1$29 ==.
                                   1160 ;	q1.c:138: SPCON &= ~0x08;               	// CPOL=0; transmit mode example|| SCK is 0 at idle state
      ...
      000280 F5 C3            [12] 1164 	mov	_SPCON,a
                           0001C6  1165 	C$q1.c$139$1$29 ==.
                                   1166 ;	q1.c:139: SPCON |= 0x04;                	// CPHA=1; transmit mode example 
      000282 43 C3 04         [24] 1167 	orl	_SPCON,#0x04
                           0001C9  1168 	C$q1.c$140$1$29 ==.
                                   1169 ;	q1.c:140: SPCON |= 0x40;                	// run spi;ENABLE SPI INTERFACE SPEN= 1 
      000285 43 C3 40         [24] 1170 	orl	_SPCON,#0x40
                           0001CC  1171 	C$q1.c$141$1$29 ==.
                                   1172 ;	q1.c:141: IEN1 |= 0x04;                	 // enable spi interrupt 
      000288 43 B1 04         [24] 1173 	orl	_IEN1,#0x04
                           0001CF  1174 	C$q1.c$142$1$29 ==.
                                   1175 ;	q1.c:142: EA=1;                         	// enable interrupts
      00028B D2 AF            [12] 1176 	setb	_EA
                           0001D1  1177 	C$q1.c$143$1$29 ==.
      ...
      00028D 22               [24] 1179 	ret
                           ...
                           0001D2  1184 	C$q1.c$150$1$29 ==.
                                   1185 ;	q1.c:150: void Timer_Init()
                                   1186 ;	-----------------------------------------
                                   1187 ;	 function Timer_Init
                                   1188 ;	-----------------------------------------
      00028E                       1189 _Timer_Init:
                           0001D2  1190 	C$q1.c$157$1$30 ==.
                                   1191 ;	q1.c:157: TH0 = 0x3C;			//For 25ms operation
      00028E 75 8C 3C         [24] 1192 	mov	_TH0,#0x3C
                           0001D5  1193 	C$q1.c$158$1$30 ==.
                                   1194 ;	q1.c:158: TL0 = 0xB0;
      000291 75 8A B0         [24] 1195 	mov	_TL0,#0xB0
                           0001D8  1196 	C$q1.c$159$1$30 ==.
                                   1197 ;	q1.c:159: TMOD = (TMOD & 0xF0) | 0x01;  	// Set T/C0 Mode Timer 0 in Mode 1(as 16 bit T/C)
      ...
      00029A F5 89            [12] 1201 	mov	_TMOD,a
                           0001E0  1202 	C$q1.c$160$1$30 ==.
                                   1203 ;	q1.c:160: ET0 = 1;                      	// Enable Timer 0 Interrupts (in IEN0 register)
      00029C D2 A9            [12] 1204 	setb	_ET0
                           0001E2  1205 	C$q1.c$161$1$30 ==.
                                   1206 ;	q1.c:161: TR0 = 1;                      	// Start Timer 0 Running 
      00029E D2 8C            [12] 1207 	setb	_TR0
                           0001E4  1208 	C$q1.c$162$1$30 ==.
      ...
      0002A0 22               [24] 1210 	ret
                           ...
                           0001E5  1215 	C$q1.c$168$1$30 ==.
                                   1216 ;	q1.c:168: void LCD_Init()
                                   1217 ;	-----------------------------------------
                                   1218 ;	 function LCD_Init
                                   1219 ;	-----------------------------------------
      0002A1                       1220 _LCD_Init:
                           0001E5  1221 	C$q1.c$170$1$31 ==.
                                   1222 ;	q1.c:170: sdelay(100);
      0002A1 90 00 64         [24] 1223 	mov	dptr,#0x0064
      0002A4 12 03 44         [24] 1224 	lcall	_sdelay
                           0001EB  1225 	C$q1.c$171$1$31 ==.
                                   1226 ;	q1.c:171: LCD_CmdWrite(0x38);   	        // LCD 2lines, 5*7 matrix
      0002A7 75 82 38         [24] 1227 	mov	dpl,#0x38
      0002AA 12 02 C0         [24] 1228 	lcall	_LCD_CmdWrite
                           0001F1  1229 	C$q1.c$172$1$31 ==.
                                   1230 ;	q1.c:172: LCD_CmdWrite(0x0E);			// Display ON cursor ON  Blinking off
      0002AD 75 82 0E         [24] 1231 	mov	dpl,#0x0E
      0002B0 12 02 C0         [24] 1232 	lcall	_LCD_CmdWrite
                           0001F7  1233 	C$q1.c$173$1$31 ==.
                                   1234 ;	q1.c:173: LCD_CmdWrite(0x01);			// Clear the LCD
      0002B3 75 82 01         [24] 1235 	mov	dpl,#0x01
      0002B6 12 02 C0         [24] 1236 	lcall	_LCD_CmdWrite
                           0001FD  1237 	C$q1.c$174$1$31 ==.
                                   1238 ;	q1.c:174: LCD_CmdWrite(0x80);			// Cursor to First line First Position
      0002B9 75 82 80         [24] 1239 	mov	dpl,#0x80
      0002BC 12 02 C0         [24] 1240 	lcall	_LCD_CmdWrite
                           000203  1241 	C$q1.c$175$1$31 ==.
      ...
      0002BF 22               [24] 1243 	ret
                           ...
                           000204  1250 	C$q1.c$182$1$31 ==.
                                   1251 ;	q1.c:182: void LCD_CmdWrite(char cmd)
                                   1252 ;	-----------------------------------------
                                   1253 ;	 function LCD_CmdWrite
                                   1254 ;	-----------------------------------------
      0002C0                       1255 _LCD_CmdWrite:
      0002C0 AF 82            [24] 1256 	mov	r7,dpl
                           000206  1257 	C$q1.c$184$1$33 ==.
                                   1258 ;	q1.c:184: LCD_Ready();
      0002C2 C0 07            [24] 1259 	push	ar7
      0002C4 12 03 27         [24] 1260 	lcall	_LCD_Ready
      0002C7 D0 07            [24] 1261 	pop	ar7
                           00020D  1262 	C$q1.c$185$1$33 ==.
                                   1263 ;	q1.c:185: LCD_data=cmd;     			// Send the command to LCD
      0002C9 8F A0            [24] 1264 	mov	_P2,r7
                           00020F  1265 	C$q1.c$186$1$33 ==.
                                   1266 ;	q1.c:186: LCD_rs=0;         	 		// Select the Command Register by pulling LCD_rs LOW
      0002CB C2 80            [12] 1267 	clr	_P0_0
                           000211  1268 	C$q1.c$187$1$33 ==.
                                   1269 ;	q1.c:187: LCD_rw=0;          			// Select the Write Operation  by pulling RW LOW
      0002CD C2 81            [12] 1270 	clr	_P0_1
                           000213  1271 	C$q1.c$188$1$33 ==.
                                   1272 ;	q1.c:188: LCD_en=1;          			// Send a High-to-Low Pusle at Enable Pin
      0002CF D2 82            [12] 1273 	setb	_P0_2
                           000215  1274 	C$q1.c$189$1$33 ==.
                                   1275 ;	q1.c:189: sdelay(5);
      0002D1 90 00 05         [24] 1276 	mov	dptr,#0x0005
      0002D4 12 03 44         [24] 1277 	lcall	_sdelay
                           00021B  1278 	C$q1.c$190$1$33 ==.
                                   1279 ;	q1.c:190: LCD_en=0;
      0002D7 C2 82            [12] 1280 	clr	_P0_2
                           00021D  1281 	C$q1.c$191$1$33 ==.
                                   1282 ;	q1.c:191: sdelay(5);
      0002D9 90 00 05         [24] 1283 	mov	dptr,#0x0005
      0002DC 12 03 44         [24] 1284 	lcall	_sdelay
                           000223  1285 	C$q1.c$192$1$33 ==.
      ...
      0002DF 22               [24] 1287 	ret
                           ...
                           000224  1294 	C$q1.c$199$1$33 ==.
                                   1295 ;	q1.c:199: void LCD_DataWrite( char dat)
                                   1296 ;	-----------------------------------------
                                   1297 ;	 function LCD_DataWrite
                                   1298 ;	-----------------------------------------
      0002E0                       1299 _LCD_DataWrite:
      0002E0 85 82 A0         [24] 1300 	mov	_P2,dpl
                           000227  1301 	C$q1.c$202$1$35 ==.
                                   1302 ;	q1.c:202: LCD_rs=1;	   			// Select the Data Register by pulling LCD_rs HIGH
      0002E3 D2 80            [12] 1303 	setb	_P0_0
                           000229  1304 	C$q1.c$203$1$35 ==.
                                   1305 ;	q1.c:203: LCD_rw=0;    	     			// Select the Write Operation by pulling RW LOW
      0002E5 C2 81            [12] 1306 	clr	_P0_1
                           00022B  1307 	C$q1.c$204$1$35 ==.
                                   1308 ;	q1.c:204: LCD_en=1;	   			// Send a High-to-Low Pusle at Enable Pin
      0002E7 D2 82            [12] 1309 	setb	_P0_2
                           00022D  1310 	C$q1.c$205$1$35 ==.
                                   1311 ;	q1.c:205: sdelay(5);
      0002E9 90 00 05         [24] 1312 	mov	dptr,#0x0005
      0002EC 12 03 44         [24] 1313 	lcall	_sdelay
                           000233  1314 	C$q1.c$206$1$35 ==.
                                   1315 ;	q1.c:206: LCD_en=0;
      0002EF C2 82            [12] 1316 	clr	_P0_2
                           000235  1317 	C$q1.c$207$1$35 ==.
                                   1318 ;	q1.c:207: sdelay(5);
      0002F1 90 00 05         [24] 1319 	mov	dptr,#0x0005
      0002F4 12 03 44         [24] 1320 	lcall	_sdelay
                           00023B  1321 	C$q1.c$208$1$35 ==.
      ...
      0002F7 22               [24] 1323 	ret
                           ...
                           00023C  1331 	C$q1.c$214$1$35 ==.
                                   1332 ;	q1.c:214: void LCD_StringWrite( char * str, unsigned char length)
                                   1333 ;	-----------------------------------------
      ...
      0002FC AF F0            [24] 1339 	mov	r7,b
                           000242  1340 	C$q1.c$216$1$37 ==.
                                   1341 ;	q1.c:216: while(length>0)
      0002FE                       1342 00101$:
      0002FE E5 14            [12] 1343 	mov	a,_LCD_StringWrite_PARM_2
      000300 60 24            [24] 1344 	jz	00104$
                           000246  1345 	C$q1.c$218$2$38 ==.
                                   1346 ;	q1.c:218: LCD_DataWrite(*str);
      ...
      000320 D0 07            [24] 1362 	pop	ar7
                           000266  1363 	C$q1.c$219$2$38 ==.
                                   1364 ;	q1.c:219: str++;
                           000266  1365 	C$q1.c$220$2$38 ==.
                                   1366 ;	q1.c:220: length--;
      000322 15 14            [12] 1367 	dec	_LCD_StringWrite_PARM_2
      000324 80 D8            [24] 1368 	sjmp	00101$
      000326                       1369 00104$:
                           00026A  1370 	C$q1.c$222$1$37 ==.
      ...
      000326 22               [24] 1372 	ret
                           ...
                           00026B  1377 	C$q1.c$229$1$37 ==.
                                   1378 ;	q1.c:229: void LCD_Ready() //*****************del
                                   1379 ;	-----------------------------------------
                                   1380 ;	 function LCD_Ready
                                   1381 ;	-----------------------------------------
      000327                       1382 _LCD_Ready:
                           00026B  1383 	C$q1.c$231$1$39 ==.
                                   1384 ;	q1.c:231: LCD_data = 0xFF;
      000327 75 A0 FF         [24] 1385 	mov	_P2,#0xFF
                           00026E  1386 	C$q1.c$232$1$39 ==.
                                   1387 ;	q1.c:232: LCD_rs = 0;
      00032A C2 80            [12] 1388 	clr	_P0_0
                           000270  1389 	C$q1.c$233$1$39 ==.
                                   1390 ;	q1.c:233: LCD_rw = 1;
      00032C D2 81            [12] 1391 	setb	_P0_1
                           000272  1392 	C$q1.c$234$1$39 ==.
                                   1393 ;	q1.c:234: LCD_en = 0;
      00032E C2 82            [12] 1394 	clr	_P0_2
                           000274  1395 	C$q1.c$235$1$39 ==.
                                   1396 ;	q1.c:235: sdelay(5);
      000330 90 00 05         [24] 1397 	mov	dptr,#0x0005
      000333 12 03 44         [24] 1398 	lcall	_sdelay
                           00027A  1399 	C$q1.c$236$1$39 ==.
                                   1400 ;	q1.c:236: LCD_en = 1;
      000336 D2 82            [12] 1401 	setb	_P0_2
                           00027C  1402 	C$q1.c$237$1$39 ==.
                                   1403 ;	q1.c:237: while(LCD_busy == 1)
      000338                       1404 00101$:
      000338 30 A7 06         [24] 1405 	jnb	_P2_7,00103$
                           00027F  1406 	C$q1.c$239$2$40 ==.
                                   1407 ;	q1.c:239: LCD_en = 0;
      00033B C2 82            [12] 1408 	clr	_P0_2
                           000281  1409 	C$q1.c$240$2$40 ==.
                                   1410 ;	q1.c:240: LCD_en = 1;
      00033D D2 82            [12] 1411 	setb	_P0_2
      00033F 80 F7            [24] 1412 	sjmp	00101$
      000341                       1413 00103$:
                           000285  1414 	C$q1.c$242$1$39 ==.
                                   1415 ;	q1.c:242: LCD_en = 0;
      000341 C2 82            [12] 1416 	clr	_P0_2
                           000287  1417 	C$q1.c$243$1$39 ==.
      ...
      000343 22               [24] 1419 	ret
                           ...
                           000288  1427 	C$q1.c$250$1$39 ==.
                                   1428 ;	q1.c:250: void sdelay(int delay)
                                   1429 ;	-----------------------------------------
      ...
      000346 AF 83            [24] 1434 	mov	r7,dph
                           00028C  1435 	C$q1.c$253$1$42 ==.
                                   1436 ;	q1.c:253: while(delay>0)
      000348                       1437 00102$:
      ...
      000354 50 0F            [24] 1445 	jnc	00108$
                           00029A  1446 	C$q1.c$255$2$43 ==.
                                   1447 ;	q1.c:255: for(d=0;d<5;d++);
