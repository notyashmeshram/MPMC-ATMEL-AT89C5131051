...
S:Lq2.LCD_CmdWrite$cmd$1$32({1}SC:S),R,0,0,[r7]
S:Lq2.LCD_DataWrite$dat$1$34({1}SC:S),R,0,0,[]
S:Lq2.LCD_StringWrite$length$1$36({1}SC:U),E,0,0
S:Lq2.LCD_StringWrite$str$1$36({3}DG,SC:S),R,0,0,[r5,r6,r7]
S:Lq2.sdelay$delay$1$41({2}SI:S),R,0,0,[r6,r7]
S:Lq2.sdelay$d$1$42({1}SC:S),R,0,0,[r5]
...
S:Fq2$__str_0$0$0({14}DA14d,SC:S),D,0,0
